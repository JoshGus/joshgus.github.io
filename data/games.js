...
export const CARDS = [
  ...
  },
  {
    ...
    descFull: 'Paste, drop, or upload any image. It reads the dominant palette and 5×5 composition in the browser, then finds public-domain paintings from Wikimedia Commons that share the same look. Slide between color and composition weighting.',
    href: 'art-match.html',
