...
export const CARDS = [
  ...
  },
  {
    ...
    descFull: 'Paste, drop, or upload any image. It reads the dominant palette and 5×5 composition in the browser, then finds public-domain paintings — from the Art Institute of Chicago and Wikimedia Commons — that share the same look. Slide between color and composition weighting.',
    href: 'art-match.html',
    thumbBg: 'linear-gradient(160deg,#1a1512,#2a1f18)',
    thumbSvg: ARTMATCH_SVG,
    stack: ['Canvas', 'AIC + Commons', 'JS'],
    category: 'component',
    credit: 'Data & images from the <a href="https://api.artic.edu/docs/" target="_blank" rel="noopener">Art Institute of Chicago API</a> and <a href="https://commons.wikimedia.org/" target="_blank" rel="noopener">Wikimedia Commons</a>',
    ctaFull: 'Open',
    ctaShort: 'Open'
  },
  {
